...
router.get('/',  function(req, res) {
  ...
  var results = [];
  var sql = "SELECT id, name, type, lotsize, price, name_jp, description, refno, lotsize_hospital, description_chronic, stock_qty, unreceived_qty, undelivered_qty FROM beads "
...
router.put('/',  function(req, res) {
  ...
  var sql = "UPDATE beads "
          ...
          + "    description_chronic = COALESCE($9, description_chronic), "
  ...
  var updBead = {
    ...
    description_chronic: req.body.description_chronic,
  ...
  connection.result(sql,
    [updBead.name, updBead.type, updBead.lotsize, updBead.price, updBead.name_jp, updBead.description, updBead.refno, updBead.lotsize_hospital, updBead.description_chronic,
...
router.post('/',  function(req, res) {
  var results = [];
  var sql = "INSERT INTO beads (name, type, lotsize, price, name_jp, description, refno, lotsize_hospital, description_chronic) "
  ...
  connection.result(sql, [newBead.name, newBead.type, newBead.lotsize, newBead.price, newBead.name_jp, newBead.description, newBead.refno, newBead.lotsize_hospital, newBead.description_chronic])
    .then(function (data) {
    })
    .catch(function (error) {
